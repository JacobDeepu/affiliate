    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="bg-profile-bg relative m-6 rounded-md border border-gray-200 bg-white bg-cover bg-top bg-no-repeat shadow sm:bg-[length:80rem_50%]">
                    <div class="grid items-center gap-4 p-10 sm:grid-cols-6 md:mt-8">
                        <div class="">
                            <img class="h-auto w-auto rounded-full bg-gray-900 shadow-lg sm:h-32 sm:w-32" src="{{ auth()->user()->profile_photo_url }}" alt="{{ auth()->user()->name }}" />
                        </div>
                    ...
                    <table class="w-full text-left text-sm text-gray-500">
                        <thead class="bg-gray-50 text-xs uppercase text-gray-700">
                            <tr>
                                ...
                                @canany(['update a refferal', 'delete a refferal'])
